...
var TransactionComponent = /** @class */ (function () {
    function TransactionComponent(translate) {
        this.translate = translate;
    }
...
var TransactionsComponent = /** @class */ (function () {
    function TransactionsComponent(sort) {
        this.sort = sort;
    ...
    TransactionsComponent.prototype.handleFilter = function (e) {
        this.transactions = _helpers_transactions__WEBPACK_IMPORTED_MODULE_3__["Transactions"].data.filter(function (t) { return t.merchant.name.toLowerCase().includes(e); });
    };
    TransactionsComponent.prototype.clearFilter = function () {
        this.transactions = _helpers_transactions__WEBPACK_IMPORTED_MODULE_3__["Transactions"].data;
        this.filter = '';
    };
    TransactionsComponent.prototype.handleSort = function (query) {
    ...
    TransactionsComponent.prototype.getClass = function (c) {
        var activeClass = (this.order === c) ? 'active' : '';
        return activeClass;
    };
...
var FormComponent = /** @class */ (function () {
    function FormComponent(translate, sort) {
        var _this = this;
        this.translate = translate;
        this.sort = sort;
        this.amount = 0.0;
        ...
        this.success = false;
        this.addData = function (transfer) {
            _this.success = true;
            _helpers_transactions__WEBPACK_IMPORTED_MODULE_4__["Transactions"].data.push(transfer);
            (_this.sort.sort === 'date') && _this.sort.sortByDate(_this.sort.asc, _helpers_transactions__WEBPACK_IMPORTED_MODULE_4__["Transactions"].data);
            (_this.sort.sort === 'merchant') && _this.sort.sortByMerchant(_this.sort.asc, _helpers_transactions__WEBPACK_IMPORTED_MODULE_4__["Transactions"].data);
            (_this.sort.sort === 'amount') && _this.sort.sortByAmount(_this.sort.asc, _helpers_transactions__WEBPACK_IMPORTED_MODULE_4__["Transactions"].data);
            setTimeout(function () {
                _this.success = false;
            }, 2000);
        };
    ...
    FormComponent.prototype.ngOnInit = function () {
        ...
        this.merchants = _helpers_transactions__WEBPACK_IMPORTED_MODULE_4__["Transactions"].data.map(function (t) { return t.merchant.name; });
    };
    FormComponent.prototype.handleConfirm = function () {
    ...
    FormComponent.prototype.save = function (form) {
        ...
        var _a = form.value, toAccount = _a.toAccount, amount = _a.amount;
        var _b = _helpers_transactions__WEBPACK_IMPORTED_MODULE_4__["Transactions"].data.find(function (item) { return (item.merchant.name === toAccount); }), categoryCode = _b.categoryCode, transaction = _b.transaction;
...
var LogoPipe = /** @class */ (function () {
    function LogoPipe() {
    }
    LogoPipe.prototype.transform = function (merchant) {
...
var SortService = /** @class */ (function () {
    ...
    SortService.prototype.setAsc = function (asc) {
        this.asc = asc;
    };
    SortService.prototype.setSort = function (sort) {
        this.sort = sort;
    };
    SortService.prototype.sortByDate = function (asc, transactions) {
        return (transactions.sort(function (a, b) {
            var x = new Date(a.dates.valueDate).getTime();
            var y = new Date(b.dates.valueDate).getTime();
            if (asc)
                return x - y;
            else
                return y - x;
    ...
    SortService.prototype.sortByAmount = function (asc, transactions) {
        if (asc)
            return transactions.sort(function (a, b) { return a.transaction.amountCurrency.amount - b.transaction.amountCurrency.amount; });
        else
            return transactions.sort(function (a, b) { return b.transaction.amountCurrency.amount - a.transaction.amountCurrency.amount; });
    };
    SortService.prototype.sortByMerchant = function (asc, transactions) {
        return (transactions.sort(function (a, b) {
            if (!asc) {
